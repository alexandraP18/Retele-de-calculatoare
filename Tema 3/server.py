            ...
            try:
                ...
                # File operations
                    ...
                    if not os.path.exists(old_path):
                        ...
                        add_history(new_name, f"Renamed from '{old_name}'", current_user)
                    ...
                    if not os.path.exists(filepath):
                        ...
                        response = {'status': 'success', 'content': content, 'message': f'File {filename} downloaded'}
                    ...
                    filename = request.get('filename')
                    if not os.path.exists(os.path.join(FILES_DIR, filename)) and filename not in file_history:
                        response = {'status': 'error', 'message': f'File {filename} not found'}
                    else:
                        history = file_history.get(filename, ["No recorded history."])
